...
```{r}
a_simulation <- read.csv("C:/Users/I0566478/OneDrive - Sanofi/Charlotte/Bibliographie/Benedicte Projet/finite_sample/data/test.csv")
a_simulation$sample.size <- as.factor(a_simulation$sample.size )
```
